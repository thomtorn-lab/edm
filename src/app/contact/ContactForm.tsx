...
// viewport on focus for any text input/textarea below 16px. No mobile/
// desktop element split exists in this form, so the same fields are bumped
// to 16px and reset back to text-sm at sm+ — leading-5 pins the line-height
// to text-sm's own default (1.25rem) at every breakpoint, so each field's
// height stays identical; only the font-size crosses the 16px threshold on
// mobile.
const inputClasses =
