...
describe("getSourceCancellationPolicy (source-driven cancellation safety, 2026-09-07)", () => {
  ...
  it("reads real per-source registry metadata (Source.cancellationPolicy), not a hardcoded id list — every one of the 25 registered sources sets it explicitly, and exactly the three cancelledHint-capable sources are 'trusted'", () => {
