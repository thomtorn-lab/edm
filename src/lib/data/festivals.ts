...
export const FESTIVALS: FestivalRecord[] = [
  ...
  mk({
    ...
    typicalMonth: "August",
    edition: confirmed("26–29 Aug 2027"),
  ...
  mk({
    ...
    officialUrl: "https://dgtl-festival.com/en/",
  }),
  mk({
    name: "Boom Festival",
    country: "Portugal",
  ...
  mk({
    ...
    location: "Dádpuszta",
    typicalMonth: "July / August",
    edition: confirmed("23 Jul–3 Aug 2027"),
  ...
  mk({
    ...
    typicalMonth: "June",
    edition: confirmed("5–6 Jun 2027"),
    genres: ["techno", "house"],
    description: "House and techno festival relocating to Glasgow for its 10th-anniversary 2027 edition, after the 2026 edition was its explicitly final outing in Edinburgh's Royal Highland Centre following nine years there.",
  ...
  mk({
    ...
    location: "Beekse Bergen, Hilvarenbeek",
    typicalMonth: "August",
    edition: confirmed("27–29 Aug 2027"),
    genres: ["hardstyle", "rawstyle", "hardcore"],
  ...
  mk({
    ...
    location: "The Garden Resort, Tisno",
    typicalMonth: "August",
    edition: confirmed("20–24 Aug 2027"),
    genres: ["techno", "house", "electronic-other"],
  ...
  mk({
    ...
    typicalMonth: "August",
    edition: confirmed("26–28 Aug 2027"),
