...
export const FESTIVALS: FestivalRecord[] = [
  ...
  mk({
    ...
    edition: datesTBA(),
    genres: ["electronic-other", "house", "techno", "trance"],
    description: "Large-scale mainstage festival held annually in Cluj-Napoca, Romania. Note: increasingly a broad pop/rock/hip-hop mega-festival (2026 headliners included Sting, Kygo, Lewis Capaldi, Zara Larsson, Flo Rida) with electronic as one of several major strands rather than the core identity — flagged for an inclusion-policy review.",
  ...
  mk({
    ...
    edition: datesTBA(),
    genres: ["techno", "house", "electronic-other"],
    description: "Non-commercial, art-driven festival on a former military airfield. Organizers have explicitly stated Fusion \"is not a genre festival\" — its line-up spans rock, hip-hop, jazz and experimental music alongside a substantial (but minority) electronic programme. Organizers announced a pause after 2026 for restructuring, with no confirmed return date yet — flagged for an inclusion-policy review alongside UNTOLD.",
